...
These skills are currently packaged for OpenCode only. Their SDO protocol and methodology content should stay portable so future adapters can reuse the same guidance without inheriting OpenCode-specific layout assumptions.
...
- Keep SDO methodology guidance adapter-neutral; isolate OpenCode-specific frontmatter, trigger wording, paths, and registration rules at this packaging layer.
